...
public class person1_main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_person1_main);

        linkTxt = findViewById(R.id.person1_likeCnt);
        followTxt = findViewById(R.id.person1_followerCnt);

        linkTxt.setText(String.valueOf(likesCnt));
        followTxt.setText(String.valueOf(followersCnt));

        about = findViewById(R.id.person1_AboutMeButt);
        like = findViewById(R.id.person1_LikeButt);
        follow = findViewById(R.id.person1_FollowButt);
    ...
    public void openExtendPage(){
        Intent intent = new Intent(this, person1_extend.class);
